...
function changeColors(document, color) {
  ...
  document.getElementById("bluesky").animate([
    {backgroundImage: `url(${currentBlueskyIcon})`},
    {backgroundImage: `url(${blueskyIcon})`},
  ], {
    duration: 500,
    fill: "forwards"
  })
